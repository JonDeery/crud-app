...
public class ClientController {
    ...
    public ModelAndView edit(@PathVariable Integer clientId) {
        ...
        mav.addObject("people", clientService.listPeoplePerClient(clientId));
        mav.addObject("peopleWithoutClient", clientService.listPeopleWithoutClient());
        mav.addObject("errors", new ArrayList<String>());
        return mav;
    }
    ...
    @RequestMapping(value = "removePerson/{personId}/{clientId}", method = RequestMethod.GET)
    public String removePerson(@PathVariable("personId") Integer personId, @PathVariable("clientId") Integer clientId) {
    	clientService.removePerson(personId);
